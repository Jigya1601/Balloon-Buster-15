...
function draw() {
 background(0);
  ...
  bow.depth = select_balloon.depth;
  ...
  //Uncomment correct option to get random number from 1 to 4 
   ...
   if (World.frameCount % 100 == 10) {
    ...
    //uncomment the correct switch statement
             ...
             case 1: redBalloon(redBalloonImage);
             break;
             case 2:blueBalloon(blueBalloonImage);
             break;
             case 3:pinkBalloon(pinkBalloonImage);
             break;
             case 4:greenBalloon(greenBalloonImage);
             break;
             default:break;
             }
}
